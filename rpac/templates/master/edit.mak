...
<div style="margin: 10px 0px; overflow: hidden;">
  <div style="float: left;">
            ...
            <div class="case-list-one">
              <div class="case-list">
                <ul>
                  ...
                  <li>
                    <input type="text" id="form1_name" name="name" class="textfield" style="width: 250px;" value="${obj.name}"/>
                  </li>
                </ul>            
              </div>
            </div>
            ...
            <div class="case-list-one">
              <div class="case-list">
	              %for l,n in [("English","english"),("Spanish (MX)","spanish_mx"),("Russian","russian"),("Arabic","arabic"),("Hebrew","hebrew"),("Polish","polish"),("Bahasa","bahasa"),("Dutch","dutch")]:
	                ...
	                <ul>
	                  <li class="label">
	                    <label for="form3_type" class="fieldlabel">Category</label>
	                  </li>
	                  <li>
	                    <select id="form3_category" name="category" style="width: 250px;">
	                        %for k,v in [( 'WASH', "Wash" ), ( 'BLEACH', "Bleach" ),( 'DRY', "Dry" ), ( 'IRON', "Iron" ),( 'DRYCLEAN', "Dry Clean" ), ( 'SPECIALCARE', "Special Care" )]:
	                            <option value="${k}" ${tw.attrs([('selected',k == obj.category)])}>${v}</option>
	                        %endfor
	                    </select>
	                  </li>
	                </ul>
    ...
    %elif t in ['Product',]:
        <div>
          <form name="groupForm" class="tableform" method="post" action="/master/save_edit" enctype="multipart/form-data">
            <input type="hidden" name="t" value="${t}"/>
            <input type="hidden" name="id" value="${obj.id}"/>
            <div class="case-list-one">
              <div class="case-list">
              %for l, n in [('Brand', 'brandId'), ('Division', 'divisionId'), ('Category', 'categoryId')]:
                <ul>
                  <li class="label">
                  ...
                  <li>
                    <select id="${n}" name="${n}" style="width: 250px;">
                      %for k,v in data[n[:-2]+'s']:
                        %if k == getattr(obj, n, None):
    ...
    %elif t in ['Size',]:
        <div>
          <form name="groupForm" class="tableform" method="post" action="/master/save_edit" enctype="multipart/form-data">
            ...
            <div class="case-list-one">
              <div class="case-list">
              %for l, n in [('Brand', 'brandId'), ('Category', 'categoryId')]:
                <ul>
                  <li class="label">
                    <label for="${n}" class="fieldlabel">${l}</label>
                  </li>
